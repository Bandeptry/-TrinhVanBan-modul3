    ...
    <div class="col-6 mt-3">
        <form method="post">
            ...
            <div class="row mb-3 mt-3">
                ...
                <div class="col-9">
                    <input type="text" name="ten" class="form-control" value="${productList.getTenSanPham()}">
                </div>
            </div>
            <div class="row mb-3 mt-3">
...
<%--                            <option value="${ct.idCate}">${ct.category}</option>--%>
                            <option
                                    <c:if test="${ct.getIdCate() == requestScope.productList.getCategory().getIdCate()}">selected</c:if>
                                    value="${ct.getIdCate()}">${ct.getCategory()}</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            <div class="row ">
                ...
                <div class="col-9 offset-3">
                    ...
                    <a href="/products"><button class="btn btn-dark" type="button">Back</button></a>
                </div>
            </div>
        </form>
    </div>
